...
- freertos f. einfaches multitasking, queues
- wlan + internet + ntp
- schrittzähler inkl. sensor
- low power 
- rtc + uhrzeit
- battery/charge monitoring
- gui
- wifi accesspoint list
- tastatur f. password eingabe
...
#define DEFAULT_SCREEN_TIMEOUT  5*1000 // changed from 30 to 5, should be sufficient to see the time
...
/*
    AXP202_EXTEN = 0, // external power
    AXP202_DCDC3 = 1, // ? esp32
    AXP202_LDO2 = 2,  // ? vielleicht bma
    AXP202_LDO4 = 3,
    AXP202_DCDC2 = 4,
    AXP202_LDO3 = 6,
 */
